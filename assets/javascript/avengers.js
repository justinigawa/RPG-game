$(document).ready(function() {
  ...
  var characters = {
    'Captain America': {
      ...
      health: 150,
      attack: 15,
      imageUrl: "assets/images/captain_america.jpe",
      enemyAttackBack: 15
    },
    'Hulk': {
      name: 'Hulk',
      health: 160,
      attack: 17,
      imageUrl: "assets/images/hulk.jpe",
      enemyAttackBack: 17
    },
    'Ironman': {
      name: 'Ironman',
      health: 175,
      attack: 15,
      imageUrl: "assets/images/ironman.jpe",
      enemyAttackBack: 12
    },
    'Loki': {
      name: 'Loki',
      health: 115,
      attack: 12,
      imageUrl: "assets/images/loki.jpe",
      enemyAttackBack: 20
    }
  };
  var currSelectedCharacter;
   ...
   var restartGame = function(inputEndGame) {
     ...
     var restart = $('<button id="restartB">Restart</button>').click(function() {
       location.reload();
     });
